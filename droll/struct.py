...
Dungeon = collections.namedtuple(
    "Dungeon", ("goblin", "skeleton", "ooze", "chest", "potion", "dragon")
)

Party = collections.namedtuple(
    "Party", ("fighter", "cleric", "mage", "thief", "champion", "scroll")
)

Roll = collections.namedtuple("Roll", ["dungeon", "party"])
